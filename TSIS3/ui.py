...
def draw_settings(surface, mx, my, W, H, fonts, settings):
    ...
    for i, d in enumerate(diffs):
        ...
        draw_button(surface, dr, d.capitalize(), btn_font, hover=dr.collidepoint(mx, my), color=col)
...
def draw_leaderboard(surface, mx, my, W, H, fonts, board):
    ...
    # title
    surface.blit(title_font.render("LEADERBOARD", True, (255,255,255)), (90, 40))

    # список
    for i, p in enumerate(board):
        text = f"{i+1}. {p['name']} - {p['score']}"
        surface.blit(btn_font.render(text, True, (255,255,255)), (80, 120 + i*30))

    # кнопка BACK
    back_rect = pygame.Rect(140, 500, 120, 40)
    ...
    pygame.draw.rect(surface, color, back_rect, border_radius=10)
    surface.blit(btn_font.render("Back", True, (255,255,255)), (165, 510))
...
def draw_name_entry(surface, mx, my, W, H, fonts, name_text):
    ...
    draw_text_center(surface, "Press ENTER to start", btn_font, LGRAY, 200, W)
